...
create table categories (id GUID not null, name varchar(255), color_blue integer, color_green integer, color_red integer, description varchar(255), obsolete boolean, primary key (id));
